...
export const API_ENDPOINTS = {
  ...
  ENROLLMENT_VERIFY_CHANNEL:
    "/api/v1/enrollment/public/sessions/{session_public_id}/channels/{verification_id}/verify",
  ENROLLMENT_CONSENT_DOCUMENT:
    "/api/v1/enrollment/public/sessions/{session_public_id}/consent-document",
  ENROLLMENT_CONSENTS:
    "/api/v1/enrollment/public/sessions/{session_public_id}/consents",
  ENROLLMENT_NOTIFICATION_PREFERENCES:
    "/api/v1/enrollment/public/sessions/{session_public_id}/notification-preferences",
  ENROLLMENT_TOPOLOGY_REQUEST:
    "/api/v1/enrollment/public/sessions/{session_public_id}/topology-request",
  ENROLLMENT_ACTIVATION_STATUS:
    "/api/v1/enrollment/public/sessions/{session_public_id}/activation-status",
  ENROLLMENT_WORKSPACE_SESSION:
    "/api/v1/enrollment/public/sessions/{session_public_id}/workspace-session",
